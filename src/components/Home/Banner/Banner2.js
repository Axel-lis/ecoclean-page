        ...
        <h1>
            ...
            <img className="card-img-top" src={esencias} alt='imagentop' />
              <div className="card-body">
                ...
                <a href="https://www.instagram.com/p/Ckl9Ny4vxSp/" class="btn btn-primary">Aprende más!</a>
              </div>
            </div>
        </Col>
        <Col style={colStyle}>
            ...
            <img className="card-img-top" src={jabones} alt='imagentop' />
              <div className="card-body">
                ...
                <a href="https://www.instagram.com/p/Cfl_-2-ujq6/?img_index=1" class="btn btn-primary">Aprende más!</a>
              </div>
            </div>
        </Col>
        <Col style={colStyle}>
      ...
      <Col style={colStyle}>
            ...
            <img className="card-img-top" src={perfumes} alt='imagentop' />
              <div className="card-body">
                ...
                <a href="https://www.instagram.com/p/CWtAtIeLgD3/" class="btn btn-primary">Aprende más!</a>
              </div>
            </div>
        </Col>
        <Col style={colStyle}>
            ...
            <img className="card-img-top" src={bombas} alt='imagentop' />
              <div className="card-body">
                ...
                <a href="https://www.instagram.com/p/CXO1LuXvSCQ/?img_index=1" class="btn btn-primary">Aprende más!</a>
              </div>
            </div>
        </Col>
        <Col style={colStyle}>
            ...
            <img className="card-img-top" src={difusor} alt='imagentop' />
              <div className="card-body">
                ...
                <a href="https://www.instagram.com/p/Cf93TC8vC5n/" class="btn btn-primary">Aprende más!</a>
              </div>
            </div>
        </Col>
      </Row>
